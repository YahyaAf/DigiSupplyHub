...
public class ShipmentController {
    ...
    public ResponseEntity<ApiResponse<ShipmentResponseDto>> getShipmentBySalesOrder(@PathVariable Long salesOrderId) {
        ApiResponse<ShipmentResponseDto> response = shipmentService.getShipmentBySalesOrder(salesOrderId);
        return ResponseEntity.ok(response);
    }

    @GetMapping("/track/{trackingNumber}")
    public ResponseEntity<ApiResponse<ShipmentResponseDto>> trackShipment(@PathVariable String trackingNumber) {
    ...
    public ResponseEntity<ApiResponse<List<ShipmentResponseDto>>> getShipmentsByStatus(@PathVariable ShipmentStatus status) {
