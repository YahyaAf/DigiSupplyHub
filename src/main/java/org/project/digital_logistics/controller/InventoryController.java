...
public class InventoryController {
    ...
    @Autowired
    public InventoryController(InventoryService inventoryService, PermissionService permissionService) {
...
//        permissionService.requireWarehouseManager(session);
    ...
    public ResponseEntity<ApiResponse<List<InventoryResponseDto>>> getInventoriesByWarehouse(
            @PathVariable Long warehouseId,
            HttpSession session) {
...
//        permissionService.requireWarehouseManager(session);
    ...
    public ResponseEntity<ApiResponse<List<InventoryResponseDto>>> getInventoriesByProduct(
            @PathVariable Long productId,
            HttpSession session) {
...
//        permissionService.requireAdmin(session);
    ...
    public ResponseEntity<ApiResponse<Integer>> getTotalStockByProduct(
            @PathVariable Long productId,
            HttpSession session) {
...
//        permissionService.requireWarehouseManager(session);
    ...
    public ResponseEntity<ApiResponse<Integer>> getAvailableStockByProduct(
            @PathVariable Long productId,
            HttpSession session) {
